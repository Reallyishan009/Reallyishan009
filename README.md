...
![Random GIF](https://api.giphy.com/v1/gifs/random?api_key=WQ3uvKrxVv3TSVYj2WSrfzzuqJuTF7MG&tag=funny&rating=g)
...
- 🔭 Currently building scalable apps with **Java**, **Spring Boot**, and **React**
- 📚 Learning advanced DSA for **FAANG interviews**
- 🎯 2025 Goals: Master **AWS**, contribute to **open-source**, and ace **coding rounds**
- 💪 Consistent with **Scaler Academy**, and a believer in lifelong learning
- ♟ Gym rat & Chess enthusiast who occasionally rocks a guitar 🎸
...
I’m always open to:
- Collaborations on impactful full-stack projects
